...
public class RegistryHandler {
	...
	public static void init(FMLInitializationEvent event) {
		...
		GameRegistry.addSmelting(CoreModBlocks.ORE_ALUMINUM, new ItemStack(CoreModItems.INGOT_ALUMINUM), 1F);
		GameRegistry.addSmelting(CoreModBlocks.ORE_COPPER, new ItemStack(CoreModItems.INGOT_COPPER), 1F);
		GameRegistry.addSmelting(CoreModBlocks.ORE_GADOLINIUM, new ItemStack(CoreModItems.INGOT_GADOLINIUM), 1F);
		GameRegistry.addSmelting(CoreModBlocks.ORE_LEAD, new ItemStack(CoreModItems.INGOT_LEAD), 1F);
		GameRegistry.addSmelting(CoreModBlocks.ORE_NICKEL, new ItemStack(CoreModItems.INGOT_NICKEL), 1F);
		...
		GameRegistry.addSmelting(CoreModBlocks.ORE_TIN, new ItemStack(CoreModItems.INGOT_TIN), 1F);
		GameRegistry.addSmelting(CoreModBlocks.ORE_ZINC, new ItemStack(CoreModItems.INGOT_ZINC), 1F);
		timer.stop();
